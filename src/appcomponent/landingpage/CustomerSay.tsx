...
export const CustomerSay = () => {
  ...
  if (Number(customerReview?.length) > 0)
    return (
      <div className="flex flex-col">
        {/* ---------- Top Section ---------- */}
        <div className="flex flex-col items-center text-center">
          <h2 className="text-3xl md:text-4xl font-semibold text-white">
            {headingData?.[0]?.heading3 || "What Our Customers Say"}
          </h2>
          <p className="text-[#686868] text-base md:text-lg mt-3">
            {headingData?.[0]?.subheading3 ||
              "Heartfelt testimonials from our satisfied customers who have experienced the warmth and quality of our outdoor heaters."}
          </p>
        </div>
