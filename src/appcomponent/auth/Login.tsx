...
//               <input
//                 type="email"
//                 className="bg-transparent border border-primary/40 rounded p-2 outline-none"
//               />
//             </div>
...
//                 </span>
//               </div>
//               <Link href='/forget-password' className="text-primary text-sm">Forget Passwod</Link>
//             </div>
...
//             <span className="text-gray-400">Don{"'"} have Account? </span>
