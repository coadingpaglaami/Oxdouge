...
//               <input
//                 type="email"
//                 className="p-2 rounded border border-primary/20  text-white outline-none bg-[#1E1E1E]"
//               />
//             </div>
//             <Button
...
//               <input
//                 type="text"
//                 className="p-2 rounded border border-primary/20 bg-[#1E1E1E] text-white outline-none"
//               />
//               <button className="absolute right-2 bottom-2 text-primary text-sm">
//                 Resend OTP
//               </button>
//             </div>
//             <Button
